    ...
    <div className="mx-auto max-w-6xl space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        ...
        <button
          ...
          onClick={() => fetchLogs()}
          disabled={loading}
          className="inline-flex items-center gap-1.5 self-start rounded-lg border border-gray-200 bg-white px-3.5 py-2 text-xs font-semibold text-gray-700 shadow-sm transition hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-primary disabled:opacity-50 sm:self-auto"
        >
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <input
              ...
              className="w-full rounded-lg border border-gray-200 px-3 py-1.5 text-xs text-gray-900 placeholder-gray-400 focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full rounded-lg border border-gray-200 px-3 py-1.5 text-xs text-gray-900 focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary"
            />
          </div>
          ...
          <table className="w-full text-left text-xs text-gray-600">
            ...
            <tbody className="divide-y divide-gray-100">
              {loading && data.items.length === 0 ? (
                ...
                data.items.map((log) => (
                  <tr key={log.id} className="transition hover:bg-gray-50/75">
                    ...
                    <td className="whitespace-nowrap px-4 py-3">
                      ...
                      {log.userId && (
                        <div className="font-mono text-[10px] text-gray-400">{log.userId}</div>
                      )}
                    </td>
                    <td className="whitespace-nowrap px-4 py-3">
                      {log.entityType ? (
                    ...
                    <td className="px-4 py-3">
                      {log.metadata && Object.keys(log.metadata).length > 0 ? (
                        <pre className="max-h-20 max-w-xs overflow-x-auto rounded bg-gray-50 p-1.5 font-mono text-[10px] text-gray-700 border border-gray-100">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 border-t border-gray-200 bg-gray-50/50 px-4 py-3 text-xs text-gray-600">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="inline-flex items-center gap-1 rounded-lg border border-gray-200 bg-white px-2.5 py-1.5 font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-primary disabled:opacity-40"
            >
